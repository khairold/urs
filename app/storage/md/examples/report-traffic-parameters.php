        ...
        <div class="row">
            <div class="col-xs-10">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active"><a href="#day3" role="tab" data-toggle="tab">Day</a></li>
                    <li><a href="#week3" role="tab" data-toggle="tab">Week</a></li>
                    <li><a href="#month3" role="tab" data-toggle="tab">Month</a></li>
                    <li><a href="#year3" role="tab" data-toggle="tab">Year</a></li>
                    <li><a href="#custom3" role="tab" data-toggle="tab">Custom</a></li>
                </ul>

                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active" id="day3">
                        <p></p>
